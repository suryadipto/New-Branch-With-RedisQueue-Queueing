...
def update_study_bias_data():
    ...
    intact_human['Publication Identifier(s)'] = intact_human['Publication Identifier(s)'].str.extract(r'(pubmed:\d+)')
    ...
    gene_bait_usage.to_csv('geneSymbol_baitUsage.txt', sep=' ')
    ...
    gene_bait_usage.set_index('gene',inplace=True)
    gene_bait_usage.to_csv('uniprotID_baitUsage.txt', sep=' ')
    ...
    gene_bait_usage.set_index('gene',inplace=True)
    gene_bait_usage.to_csv('entrezID_baitUsage.txt', sep=' ')
    ...
    study_att.to_csv('geneSymbol_studyAttention.txt', sep=' ')
    ...
    study_att.set_index('gene', inplace=True)
    study_att.to_csv('uniprotID_studyAttention.txt', sep=' ')
    ...
    study_att.set_index('gene', inplace=True)
    study_att.to_csv('entrezID_studyAttention.txt', sep=' ')
